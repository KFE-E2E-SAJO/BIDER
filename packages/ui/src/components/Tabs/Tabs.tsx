...
//       data-slot="tabs-list"
//       className={cn(
//         'bg-muted text-muted-foreground inline-flex w-fit items-center justify-center gap-2',
//         className
//       )}
//       {...props}
//     />
...
//       className={cn(
//         `
//           cursor-pointer rounded-full border border-[var(--neutral-300)]
//           px-3 py-2 text-[var(--neutral-700)]
//           data-[state=active]:border-[var(--neutral-900)] data-[state=active]:bg-[var(--neutral-900)]
//           data-[state=active]:text-[var(--neutral-0)]
//         `,
//         className
//       )}
//       {...props}
